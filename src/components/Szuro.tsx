...
function SzuroOpciok() {
  ...
  return (
    <div className="justify-center items-center px-[8vw] flex-wrap gap-2 flex flex-col md:flex-row z-10">
      <select
        name="stilus"
...
export default function Szuro() {
  ...
  return (
    <div className="bg-gray-100 py-2 md:fixed md:top-16 md:w-full z-10">
