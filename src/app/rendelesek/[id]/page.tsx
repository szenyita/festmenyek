  ...
  if (!context?.contextFelhasznalo) {
    return (
      <div className="mt-6 mx-12 mb-auto flex flex-col min-h-[calc(100vh-368px)] lg:w-[660px] lg:mx-auto lg:mt-16">
        ...
        <div className="grid grid-cols-2 py-1 px-2 bg-black text-white rounded-t-md border-black border-t-2 border-l-2 border-r-2 md:w-[660px]">
          <div className="px-2">Név</div>
          <div className="px-2">Vételár</div>
        </div>
      </div>
    );
  }
    ...
    <div className="mt-6 mx-12 mb-auto flex flex-col min-h-[calc(100vh-368px)] lg:w-[660px] lg:mx-auto lg:mt-16">
      ...
      {rendeles?.festmenyek.map((termek) => (
        <div
          ...
          className="py-1 px-2 odd:bg-gray-200 border-gray-200 border-l-2 border-r-2 last:rounded-b-md last:border-b-2 md:w-[660px]"
        >
          <Link
          ...
          >
            <div className="px-2">{termek.nev}</div>
            <div className="px-2">{formatCurrency(termek.ar)}</div>
          </Link>
        </div>
      ))}
    </div>
